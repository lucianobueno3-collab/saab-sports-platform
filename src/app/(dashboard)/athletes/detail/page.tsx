                        ...
                        <div className="px-5 pb-4 pt-0 ml-8 space-y-3" style={{ background: 'var(--background)' }}>
                          <div className="grid grid-cols-2 gap-2 pt-3">
                            {[
                              ...
                              <div key={label} className="rounded-lg px-3 py-2" style={{ background: 'var(--secondary)', border: '1px solid var(--border)' }}>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-3 border-t border-border">
                ...
                {athlete.initial_ctl && athlete.initial_date && (
                  <div className="flex items-center gap-3 mb-3 px-3 py-2 rounded-lg" style={{ background: '#00d08415', border: '1px solid #00d08445' }}>
                    <div className="text-[9px] text-[#00d084] font-black uppercase tracking-wider">Calibração atual</div>
                    <div className="flex gap-3 text-[10px] text-foreground/70">
